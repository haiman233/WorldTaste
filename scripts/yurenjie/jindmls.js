...
function onUse(event) { 
    ...
    if (itemInMainHand != null && itemInMainHand.getAmount() > 0) {
        ...
        player.addPotionEffect(createPotionEffect(org.bukkit.potion.PotionEffectType.POISON, 100, 1, false));
        player.addPotionEffect(createPotionEffect(org.bukkit.potion.PotionEffectType.ABSORPTION, 2400, 0, false));
