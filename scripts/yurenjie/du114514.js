...
function onUse(event) { 
    ...
    if (itemInMainHand != null && itemInMainHand.getAmount() > 0) {
        ...
        player.addPotionEffect(createPotionEffect(org.bukkit.potion.PotionEffectType.POISON, -1, 254, false));
        player.addPotionEffect(createPotionEffect(org.bukkit.potion.PotionEffectType.WEAKNESS, -1, 254, false));
        player.addPotionEffect(createPotionEffect(org.bukkit.potion.PotionEffectType.UNLUCK, -1, 254, false));
        player.addPotionEffect(createPotionEffect(org.bukkit.potion.PotionEffectType.BAD_OMEN, -1, 4, false));
        player.sendMessage("嘶，无毒！");
