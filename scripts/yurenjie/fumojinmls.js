...
function onUse(event) { 
    ...
    if (itemInMainHand != null && itemInMainHand.getAmount() > 0) {
        ...
        player.setSaturation(player.getSaturation() + 4.8);
        player.addPotionEffect(createPotionEffect(org.bukkit.potion.PotionEffectType.POISON, 400, 7, false));
        player.addPotionEffect(createPotionEffect(org.bukkit.potion.PotionEffectType.ABSORPTION, 2400, 3, false));
        player.addPotionEffect(createPotionEffect(org.bukkit.potion.PotionEffectType.LUCK, 6000, 4, false));
        player.addPotionEffect(createPotionEffect(org.bukkit.potion.PotionEffectType.UNLUCK, 6000, 4, false));
