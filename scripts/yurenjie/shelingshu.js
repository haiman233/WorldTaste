...
function onUse(event) { 
    ...
    if (itemInMainHand != null && itemInMainHand.getAmount() > 0) {
        ...
        player.addPotionEffect(createPotionEffect(org.bukkit.potion.PotionEffectType.POISON, 280, 0, false));
        player.addPotionEffect(createPotionEffect(org.bukkit.potion.PotionEffectType.WITHER, 50, 2, false));
    

        // 使用正确的声音名称
        var soundName = "entity.spider.ambient";
