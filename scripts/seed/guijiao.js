...
function tick(info) {
    ...
    // 处理无尽植物生长逻辑
    if (machinesf === "WT_SEED_GUIJIAO") {
        handleGrowth(world, location, lastUseTime, currentTime, "WT_SEED_GUIJIAO");
    }
}
...
function handleHarvest(world, location) {
    ...
    if (sfItem.getId() === "WT_SEED_GUIJIAO") {
        let dropItem = (itemId) => {
