...
function handleHarvest(world, location) {
    ...
    if (sfItem.getId() === "WT_SEED_TONGNIAN") {
        // 定义所有可能掉落的物品及其掉落概率
        let drops = [
            { itemId: "WT_WANDOUSHESHOU", probability: 0.2 },
            { itemId: "WT_DAZUIHUA", probability: 0.12 },
            { itemId: "WT_HUIMIE", probability: 0.1 },
            { itemId: "WT_XIANGRIKUI", probability: 0.5 },
            { itemId: "WT_MALIAOMOGU", probability: 0.08 }
        ];
