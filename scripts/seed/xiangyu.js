...
function tick(info) {
    ...
    // 处理无尽植物生长逻辑
    if (machinesf === "WT_SEED_XIANGYU") {
        handleGrowth(world, location, lastUseTime, currentTime, "WT_SEED_XIANGYU");
    }
}
...
function handleHarvest(world, location) {
    ...
    if (sfItem.getId() === "WT_SEED_XIANGYU") {
        let dropItem = (itemId) => {
